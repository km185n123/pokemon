...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is LanguageDto&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url));
}
...
@override
String toString() {
  return 'LanguageDto(name: $name, url: $url)';
}
...
class _LanguageDto implements LanguageDto {
  const _LanguageDto({required this.name, required this.url});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _LanguageDto&&(identical(other.name, name) || other.name == name)&&(identical(other.url, url) || other.url == url));
}
